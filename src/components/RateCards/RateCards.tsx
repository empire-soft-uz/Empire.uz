                ...
                data-aos-duration="1500">
                    <div className={styles.rowItem}>
                        ...
                        <div className={styles.textBox}>
                            ...
                            <Text text={item.name} textSize='sixteen' family="FuturaBook" />
                        </div>
                    </div>
                        ...
                        {item.info.map((e, index) => {
                            return (
                                <div className={styles.item}>
                                    <img width={20} height={20} src={ASSETS.check} alt="" />
                                    <Text key={index} text={e.name} textSize={'fourteen'} />
                                </div>
                            )
                        })}
                          <div className={styles.priceBox}>    
                            <Text margin='10px 0' textAlign={"center"} text={item.price} textSize={'twentyEight'} />
                            <Text margin='10px 0' textAlign={"center"} text={`/${item.period}`} textSize={'fourteen'} />
                          </div>
                          <button onClick={() => OpenForm(item.title)} className={styles.btn}>Contact</button>
                    </div>
                </div>
              )
          })}
